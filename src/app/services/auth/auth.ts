...
export class AuthService {
  ...
  /*Controlla se esiste un token nel browser. Se esiste, fa una chiamata al server per recuperare i dati dell'utente, ne stabilisce il ruolo (admin/user) 
   * e aggiorna lo stato dell'applicazione. Se il token è scaduto o assente, svuota la sessione.*/
  ...
  /*Cancella il token di autenticazione dalla memoria del browser (localStorage) e resetta l'utente corrente a 'null', notificando a tutta l'app la disconnessione.*/
  logout() {
